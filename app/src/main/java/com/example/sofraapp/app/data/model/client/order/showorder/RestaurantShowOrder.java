...
public class RestaurantShowOrder {
    ...
    @Expose
    private RegionShowOrder region;
    @SerializedName("categories")
    @Expose
    private List<CategoryShowOrder> categories = null;
    ...
    public RegionShowOrder getRegion() {
        return region;
    }

    public void setRegion(RegionShowOrder region) {
        this.region = region;
    }

    public List<CategoryShowOrder> getCategories() {
        return categories;
    }

    public void setCategories(List<CategoryShowOrder> categories) {
