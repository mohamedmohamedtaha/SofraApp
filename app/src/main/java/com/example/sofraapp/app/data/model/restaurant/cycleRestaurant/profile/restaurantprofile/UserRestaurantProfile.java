...
public class UserRestaurantProfile {
    ...
    @Expose
    private RegionRestaurantProfile region;
    ...
    public RegionRestaurantProfile getRegion() {
        return region;
    }

    public void setRegion(RegionRestaurantProfile region) {
        this.region = region;
    }
