package com.example.sofraapp.app.helper.library.multispinner;
...
//        });
            ...
            builder.setPositiveButton("Submit", new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialog, int which) {
                    if (singSelection && getSelectedStrings().size() > 1) {
                        Toast.makeText(context, "You can't select more then one item..", Toast.LENGTH_SHORT).show();
...
//        mSelection[0] = true;
    ...
    public void singSelection(boolean val, Context context){
        singSelection = val;
