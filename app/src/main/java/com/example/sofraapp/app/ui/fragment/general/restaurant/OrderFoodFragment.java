...
public class OrderFoodFragment extends Fragment {
    ...
    public static final String DETAILS_RESTUARANT = "details_retaurant";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adapterOrderFood = new AdapterOrderFood(getActivity(), restaurantsArrayList, new AdapterOrderFood.showDetial() {
            ...
            public void itemShowDetail(Data2Restaurants position) {
                ...
                SaveData saveData = new SaveData(detailRestaurant);
               // Bundle bundle = new Bundle();
               // bundle.putInt(DETAILS_RESTUARANT,detailRestaurant);
                HelperMethod.replece(detailRestaurantFragment, getActivity().getSupportFragmentManager(), R.id.Cycle_Home_contener, toolbar, getString(R.string.list_food),saveData);
            }
        });
