...
import com.example.sofraapp.app.data.model.cycleRestaurant.cyclelogin.register.Register;
...
public class RegisterAsRestaurantTwoFragment extends Fragment {
    ...
    @BindView(R.id.RegisterAsRestaurantFragmentOne_BT_Register)
    Button RegisterAsRestaurantFragmentOneBTRegister;
    Unbinder unbinder;
    SaveData saveData;
    ...
    @OnClick({R.id.EditProfileUserFragment_IM_Add_Photo, R.id.RegisterAsRestaurantFragmentOne_BT_Register})
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.EditProfileUserFragment_IM_Add_Photo:
                ...
                break;
            case R.id.RegisterAsRestaurantFragmentOne_BT_Register:
