...
public class Data2RegisterAsRestaurant {
    ...
    @Expose
    private RegionRegisterAsRestaurant region;
    ...
    public RegionRegisterAsRestaurant getRegion() {
        return region;
    }

    public void setRegion(RegionRegisterAsRestaurant region) {
        this.region = region;
    }
